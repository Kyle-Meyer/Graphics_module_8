...
std::shared_ptr<cg::SceneNode> construct_room(std::shared_ptr<cg::UnitSquareSurface> unit_square)
{
    ...
    auto floor_material = std::make_shared<cg::ColorNode>(cg::Color4(0.3f, 0.45f, 0.1f));

    // Make the walls reddish, slightly shiny
    auto wall_material = std::make_shared<cg::ColorNode>(cg::Color4(0.7f, 0.55f, 0.55f));

    // Ceiling should be white, moderately shiny
    auto ceiling_material = std::make_shared<cg::ColorNode>(cg::Color4(1.0f, 1.0f, 1.0f));
...
std::shared_ptr<cg::SceneNode> construct_vase(const int position_loc, const int normal_loc)
{
    ...
    auto vase_material = std::make_shared<cg::ColorNode>(cg::Color4(0.95f, 0.35f, 0.65f));
...
void construct_scene()
{
    ...
    auto wood = std::make_shared<cg::ColorNode>(cg::Color4(0.55f, 0.45f, 0.15f));
    ...
    auto teapot_material =
        std::make_shared<cg::ColorNode>(cg::Color4(0.50754f, 0.50754f, 0.50754f));
    ...
    auto box_material = std::make_shared<cg::ColorNode>(cg::Color4(0.5f, 0.25f, 0.25f));
    ...
    auto cone_material = std::make_shared<cg::ColorNode>(cg::Color4(0.75164f, 0.60648f, 0.22648f));
   ...
   // Construct a unit sphere
   auto sphere = std::make_shared<cg::SphereSurface>(36, 18, position_loc, normal_loc);
   
   // Sphere material - shiny, bluish color
   auto sphere_material = std::make_shared<cg::ColorNode>(cg::Color4(0.3f, 0.5f, 0.8f));
   
   // Position sphere along right wall at (80, 20) with radius 10
   ...
   add_sub_tree(g_camera, sphere_material, sphere_transform, sphere);
}
