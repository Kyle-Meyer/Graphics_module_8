...
#include "Module7/shader_src.hpp"
...
void logmsg(const char *message, ...)
{
    ...
    if(lfile == NULL) { lfile = fopen("Module7.log", "w"); }
...
void construct_scene()
{
    ...
    if(!shader->create("Module7/simple_light.vert", "Module7/simple_light.frag") ||
